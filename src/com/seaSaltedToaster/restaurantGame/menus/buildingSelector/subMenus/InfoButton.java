...
public class InfoButton extends UiComponent {
	...
	public InfoButton(BuildingViewer viewer) {
		super(7);
		createPanel();
		this.viewer = viewer;
	}
	...
	private void createPanel() {
		...
		this.iconTex = engine.getTextureLoader().loadTexture("/uis/info");
