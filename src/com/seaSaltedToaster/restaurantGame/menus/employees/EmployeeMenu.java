...
public class EmployeeMenu extends UiComponent implements ScrollListener {
	...
	public EmployeeMenu() {
		...
		this.smoothScroll = new SmoothFloat(0.0f);
	...
	private void createPanel() {
		...
		titleBackCons.setX(new AlignX(HorizontalAlignment.CENTER));
		titleBackCons.setY(new AlignY(VerticalAlignment.TOP, 0.0f));
		...
		textCons.setY(new AlignY(VerticalAlignment.TOP, 0.33f));
